...
public class LayerBitmapManager {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$android$graphics$Bitmap$Config = new int[0];
        public static final /* synthetic */ int[] $SwitchMap$com$artifex$solib$ArDkBitmap$Type = new int[0];
