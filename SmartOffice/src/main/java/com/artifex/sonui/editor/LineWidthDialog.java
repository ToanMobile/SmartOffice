    ...
    public static void show(Context context, View view, final ArDkDoc arDkDoc) {
        ...
        while (true) {
            ...
            if (i < fArr.length) {
                ...
                wheelView.scrollingListeners.add(new OnWheelScrollListener(lineWidthDialog) {
                ...
                nUIPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener(lineWidthDialog) {
